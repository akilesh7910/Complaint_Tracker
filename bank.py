...
df = pd.read_csv(r"C:\Users\akile\Desktop\bank_review\banca_translated.csv");
df_tx = pd.read_csv(r"C:\Users\akile\Desktop\bank_review\bank_taxonomy.csv");

#function that identifies taxonomy words ending with (*)
...
#function that removes all punctuations.
...
#function to remove just the quotes("").
...
#output mapped data
mapped_data.to_csv("C:\\Users\\akile\\Desktop\\bank_review\\mapped_data_bank.csv",index = False)


#read category mapped data for sentiment mapping
catdata = pd.read_csv("C:\\Users\\akile\\Desktop\\bank_review\\mapped_data_bank.csv")
...
catdata.to_csv("C:\\Users\\akile\\Desktop\\bank_review\\sentiment_mapped_data_bank.csv",index = False)
